...
class ExportPreviewValidator implements ValidatorInterface
{
    ...
    public function validate(): void
    {
        ...
        if ($product->isAvailable() === false) {
            throw new ExportPreviewValidationException(sprintf('Product "%s" (ID: %s) is not enabled.',
        ...
        if (
            ...
            throw new ExportPreviewValidationException(sprintf('Product "%s" (ID: %s) has "Visibility" set to "Not Visible Individually".',
                                                               $product->getName(), $product->getId()
                                                       )
            );
        }
