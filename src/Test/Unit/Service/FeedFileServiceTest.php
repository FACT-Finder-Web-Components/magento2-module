...
class FeedFileServiceTest extends TestCase
{
    ...
    public function test_will_throw_exception_on_empty_export_type()
    {
        ...
        $this->assertSame('export.test_typeData.test_channel.csv', $this->feedFileService->getFeedExportFilename('', 'test_channel'));
    }
    ...
    public function test_will_throw_exception_on_empty_export_channel()
    {
        ...
        $this->assertSame('export.test_typeData.test_channel.csv', $this->feedFileService->getFeedExportFilename('test_type', ''));
    }
    ...
    public static function validDataProvider(): array
    {
        return [
            [
                'test_type', 'test_channel', 'export.test_typeData.test_channel.csv'
            ]
        ];
    }
