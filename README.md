...
- [Installation](#markdown-header-installation)
	- [Installation des Moduls über ein gepacktes Archiv](#markdown-header-installation-des-moduls-uber-ein-archiv)
	- [Aktivierung des Moduls](#markdown-header-aktivierung-des-moduls)
- [Backend Konfiguration](#markdown-header-backend-konfiguration)
	- [Allgemeine Einstellungen](#markdown-header-allgemeine-einstellungen)
	- [Aktivierte Web-Komponenten](#markdown-header-aktivierte-web-komponenten)
	- [Erweiterte Einstellungen](#markdown-header-erweiterte-einstellungen)
	- [Produktdaten-Export](#markdown-header-produktdaten-export)
- [Web-Komponenten Integration](#markdown-header-web-komponenten-integration)
	- [Überblick relevanter Dateien](#markdown-header-uberblick-relevanter-dateien)
	- [Suchbox Integration und Funktionsweise](#markdown-header-suchbox-integration-und-funktionsweise)
	- [Ablauf der Datenkommunikation zwischen dem Shop und FACT-Finder](#markdown-header-ablauf-der-datenkommunikation-zwischen-dem-shop-und-fact-finder)
